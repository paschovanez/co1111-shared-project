...
function getQuestion()
{
    ...
    fetch("https://codecyprus.org/th/test-api/question?" + getCookie('p1') + getCookie('p2') + getCookie('p3'))
        ...
        .then(jsonObject => {
            ...
            {
                document.getElementById('locationReq').style.display='block';
            }
        });
}
...
function NextCamera()
{
    Instascan.Camera.getCameras().then(function (cameras) // for some reason camera does not switch on an iPhone
    {
